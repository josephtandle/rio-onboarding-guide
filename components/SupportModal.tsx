  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="mx-4 w-full max-w-sm rounded-xl bg-rio-white p-6 shadow-xl">
        ...
        <p className="mb-6 text-sm text-rio-green">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-rio-green/20 bg-rio-white px-4 py-3 text-sm font-medium text-rio-black no-underline hover:bg-rio-beige"
          >
            <EmailIcon />
